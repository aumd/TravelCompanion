...
var markers = [];
var autocomplete;
var countryRestrict = { 'country': 'ph' };
...
var countries = {
  ...
  'ph': {
		center: new google.maps.LatLng(11.3333, 123.0167),
		zoom: 7
	},
  'pt': {
...
function initialize() {
  var myOptions = {
    zoom: countries['ph'].zoom,
    center: countries['ph'].center,
...
function buildIWContent(place) {
  document.getElementById('iw-icon').innerHTML = '<img class="hotelIcon" ' +
      'src="' + place.icon + '"/>';
  document.getElementById('iw-url').innerHTML = '<b><a href="' + 'RoomList.html' +
      '">' + place.name + '</a></b>';
